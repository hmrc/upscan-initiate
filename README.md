...
Assuming the consuming service is whitelisted, it makes a POST request to the `https://upscan-initiate.public.mdtp/upscan/initiate` endpoint. This request includes details about the expected upload - constraints on size and the callback URL.
